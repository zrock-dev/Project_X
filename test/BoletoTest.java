...
public class BoletoTest {
    ...
    public void clienteConTicketGratis(){
        ...
        boleteria.registrarCliente(10101001, "DIEGO FIGUEROA", "Boliviano",
                "03/01/2018");
        Cliente cliente = boleteria.registroClientes.get(10101001);
        cliente.cantidadTicketsGratis = 3;
        boleteria.comprarBoleto(10101001,Boleteria.MetodoPago.TARJETA , "A", 4,
                "A", Semana.DOMINGO);
